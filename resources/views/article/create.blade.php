                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('article.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="description" value="{{ old('title') }}">
                            </div>
                            <div class="form-group">
                                <label for="title">FbPhoto</label>
                                <input type="file" required class="form-control p-1" placeholder="225*225" name="og_photo">
                                @error('og_photo')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content" rows="30" class="form-control">{{ old('title') }}</textarea>
                            </div>
                            <div class="form-group">
