...
<head>
    ...
    @component('components.meta')
        <link rel="canonical" href="http://www.ingyinnews.online/post/{{ $post->id }}">
        <!-- Primary Meta Tags -->
        ...
        <meta property="og:url" content="http://www.ingyinnews.online/post/{{ $post->id }}">
        <meta property="og:title" content="{{ $post->title }}">
        <meta property="og:description" content="{{ $post->description }}">
        <meta property="og:image" content="http://www.ingyinnews.online/storage/photo/{{ $post->og_photo }}">


        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="http://www.ingyinnews.online/post/{{ $post->id }}">
        <meta property="twitter:title" content="{{ $post->title }}">
        <meta property="twitter:description" content="{{ $post->description }}">
        <meta property="twitter:image" content="http://www.ingyinnews.online/storage/photo/{{ $post->og_photo }}">
    @endcomponent
