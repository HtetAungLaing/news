...
<head>
    ...
    @component('components.meta')
        <link rel="canonical" href="http://45.77.168.97/post/{{ $post->id }}">
        <!-- Primary Meta Tags -->
        ...
        <meta property="og:url" content="http://45.77.168.97/post/{{ $post->id }}">
        <meta property="og:title" content="{{ $post->title }}">
        <meta property="og:description" content="{{ $post->description }}">
        <meta property="og:image" content="http://45.77.168.97/storage/photo/{{ $post->og_photo }}">


        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="http://45.77.168.97/post/{{ $post->id }}">
        <meta property="twitter:title" content="{{ $post->title }}">
        <meta property="twitter:description" content="{{ $post->description }}">
        <meta property="twitter:image" content="http://45.77.168.97/storage/photo/{{ $post->og_photo }}">
    @endcomponent
